...
export const translations = {
  ko: {
    ...
    auth: {
      ...
      createAccount: "회원가입",
      forgotAccount: "계정이 기억나지 않으신가요?",
      findAccount: "계정확인",
      findAccountTitle: "계정 확인",
      findAccountDescription: "역할을 선택하고 정보를 입력하시면 이메일 계정을 찾아드립니다",
      studentNumber: "학번",
      childStudentNumber: "자녀의 학번",
      childName: "자녀의 이름",
      selectRole: "역할 선택",
      roleStaff: "교직원",
      roleStudent: "학생",
      roleParent: "학부모",
      accountFound: "계정을 찾았습니다",
      accountNotFound: "일치하는 계정을 찾을 수 없습니다",
      accountFoundMessage: "귀하의 이메일 계정은 다음과 같습니다",
  ...
  en: {
    ...
    auth: {
      ...
      findAccountDescription: "Select your role and enter information to find your email account",
      studentNumber: "Student Number",
      childStudentNumber: "Child's Student Number",
      ...
      accountNotFound: "No matching account found",
      accountFoundMessage: "Your email account is",
