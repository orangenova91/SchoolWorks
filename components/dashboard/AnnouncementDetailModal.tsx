...
import { X, User, Calendar, Edit, Trash2, Users, Download, Share2 } from "lucide-react";
...
export function AnnouncementDetailModal({
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 flex-shrink-0">
          ...
          <div className="flex items-center gap-1 flex-shrink-0 ml-4">
            <button
              type="button"
              onClick={() => {
                const url = `${typeof window !== "undefined" ? window.location.origin : ""}${typeof window !== "undefined" ? window.location.pathname : ""}?announcement=${announcement.id}`;
                if (typeof navigator !== "undefined" && navigator.clipboard?.writeText) {
                  ...
                  showToast("링크 복사가 지원되지 않는 환경입니다.", "error");
                }
              }}
  ...
  return (
    <>
      ...
      {deleteConfirmDialog && createPortal(deleteConfirmDialog, document.body)}
    </>
  );
}
